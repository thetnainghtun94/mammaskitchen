                            ...
                            <ul id="menu-pricing" class="menu-price">
                                @foreach($items as $item)
                                    <li class="item" id="{{ $item->category->slug}}">
                                        <a href="#">
                                            <img src="{{ asset('uploads/item/'. $item->image) }}"
                                            class="img-responsive" alt="Item" style="width: 282px; height: 230px;">
                    ...
                    <div class="col-md-6 col-md-offset-3">
                        <div class="copyright text-center">
                            <p>
                                ...
                                Developed by <a href="https://github.com/thetnainghtun94">Thetnainghtun</a> 
